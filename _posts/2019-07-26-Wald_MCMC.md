...
```
<img src="https://github.com/bayestour/blog/blob/master/images/posts/wald_r_traceplot.png">
```{python}
# Python
...
```
<img src="https://github.com/bayestour/blog/blob/master/images/posts/wald_python_traceplot.png">
...
```
z의 신용구간은 [.45, .83], v는 [0.89, 1.81], t0는 [0.34, 0.42] 가량인 것을 볼 수 있습니다. 마지막으로 acceptance rate를 확인하면 65% 가량인 것을 확인할 수 있습니다. 이 정도는 괜찮은 값이라고 할 수 있습니다. 참고로 권장되는 값은 65%입니다:
```{r}
# R
